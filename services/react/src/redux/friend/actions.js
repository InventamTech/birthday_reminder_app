...
export const bulkAddFriend = (files) => ({
	type: BULK_ADD_FRIEND,
	payload: { files },
});
export const bulkAddFriendSuccess = () => ({
	type: BULK_ADD_FRIEND_SUCCESS,
	payload: {},
});
export const bulkAddFriendError = (text) => ({
	type: BULK_ADD_FRIEND_ERROR,
	payload: { text },
});

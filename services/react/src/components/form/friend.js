...
import { Paper, Tabs, Tab, DialogContentText, Grid } from '@material-ui/core';
...
import PaperDropzone from './paper-dropzone'
					...
					<DialogContentText>
						...
						<Paper >
							<Tabs
								...
								onChange={(val, index) => this.setState({
									tab: index
								})}
								...
								centered
							>
								<Tab label="Single insert" />
								<Tab label="Bulk insert" />
							</Tabs>
						</Paper>
